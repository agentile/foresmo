        ...
        <div class="grid_16">
            <h2 class="page-heading">Posts &#187; Manage</h2>
            <h2 class="page-heading-right"><?php echo $this->blog_title;?> administration</h2>
        </div>
        <div class="grid_16">
            <table id="manage_posts" summary="Posts">
                ...
                <tfoot>
                    <tr>
                        ...
                        <td colspan="6" style="text-align:right;padding-right:30px;"><?php echo (count($this->data) == 1) ? '1 Post' : count($this->data) . ' Posts'; ?></td>
                    </tr>
                </tfoot>
                <tbody>
                    <?php
                    foreach ($this->data as $key => $page_info) {
                        ...
                        echo '<td><a href="/'.$page_info['slug'].'" target="_blank">View</a> | <a href="/admin/posts/edit/'.$page_info['slug'].'">Edit</a> | <a href="/admin/posts/delete/'.$page_info['slug'].'">Delete</a></td>';
                        echo '</tr>';
                    }
                    ?>
                </tbody>
