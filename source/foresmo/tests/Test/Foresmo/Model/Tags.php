 ...
 * 
 */
class Test_Foresmo_Model_Tags extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Foresmo_Model_Tags = array(
    );
    ...
    {
        $obj = Solar::factory('Foresmo_Model_Tags');
        $this->assertInstance($obj, 'Foresmo_Model_Tags');
    }
