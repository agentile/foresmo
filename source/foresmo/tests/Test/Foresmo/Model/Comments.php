 ...
 * 
 */
class Test_Foresmo_Model_Comments extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Foresmo_Model_Comments = array(
    );
    ...
    {
        $obj = Solar::factory('Foresmo_Model_Comments');
        $this->assertInstance($obj, 'Foresmo_Model_Comments');
    }
