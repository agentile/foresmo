 ...
 * 
 */
class Test_Foresmo_Model_PostsTags extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Foresmo_Model_PostsTags = array(
    );
    ...
    {
        $obj = Solar::factory('Foresmo_Model_PostsTags');
        $this->assertInstance($obj, 'Foresmo_Model_PostsTags');
    }
     ...
     * 
     */
    public function testSetPostTags()
    {
        $this->todo('stub');
    }
