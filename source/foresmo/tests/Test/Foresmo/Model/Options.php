 ...
 * 
 */
class Test_Foresmo_Model_Options extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Foresmo_Model_Options = array(
    );
    ...
    {
        $obj = Solar::factory('Foresmo_Model_Options');
        $this->assertInstance($obj, 'Foresmo_Model_Options');
    }
