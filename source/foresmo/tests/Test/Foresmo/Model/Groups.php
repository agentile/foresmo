 ...
 * 
 */
class Test_Foresmo_Model_Groups extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Foresmo_Model_Groups = array(
    );
    ...
    {
        $obj = Solar::factory('Foresmo_Model_Groups');
        $this->assertInstance($obj, 'Foresmo_Model_Groups');
    }
