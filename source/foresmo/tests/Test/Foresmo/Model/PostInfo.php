 ...
 * 
 */
class Test_Foresmo_Model_PostInfo extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Foresmo_Model_PostInfo = array(
    );
    ...
    {
        $obj = Solar::factory('Foresmo_Model_PostInfo');
        $this->assertInstance($obj, 'Foresmo_Model_PostInfo');
    }
    ...
    /**
     * 
     * Test -- commentsDisabled Check to see if comments are disabled for a post.
     * 
     */
