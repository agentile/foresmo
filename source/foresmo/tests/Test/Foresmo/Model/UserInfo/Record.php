 ...
 * 
 */
class Test_Foresmo_Model_UserInfo_Record extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Foresmo_Model_UserInfo_Record = array(
    );
    ...
    {
        $obj = Solar::factory('Foresmo_Model_UserInfo_Record');
        $this->assertInstance($obj, 'Foresmo_Model_UserInfo_Record');
    }
