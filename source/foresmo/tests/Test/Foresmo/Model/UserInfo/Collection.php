 ...
 * 
 */
class Test_Foresmo_Model_UserInfo_Collection extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Foresmo_Model_UserInfo_Collection = array(
    );
    ...
    {
        $obj = Solar::factory('Foresmo_Model_UserInfo_Collection');
        $this->assertInstance($obj, 'Foresmo_Model_UserInfo_Collection');
    }
