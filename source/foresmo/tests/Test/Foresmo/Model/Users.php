 ...
 * 
 */
class Test_Foresmo_Model_Users extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Foresmo_Model_Users = array(
    );
    ...
    {
        $obj = Solar::factory('Foresmo_Model_Users');
        $this->assertInstance($obj, 'Foresmo_Model_Users');
    }
    ...
    /**
     * 
     * Test -- checkEmailExists Checks to see if e-mail address supplied is an e-mail address of one of the blogs registered users.
     * 
     */
    ...
    /**
     * 
     * Test -- checkUsernameExists Checks to see if e-mail address supplied is an e-mail address of one of the blogs registered users.
     * 
     */
    ...
    /**
     * 
     * Test -- validUser Given credentionals, is this a valid user.
     * 
     */
