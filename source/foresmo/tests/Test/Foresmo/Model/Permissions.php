 ...
 * 
 */
class Test_Foresmo_Model_Permissions extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Foresmo_Model_Permissions = array(
    );
    ...
    {
        $obj = Solar::factory('Foresmo_Model_Permissions');
        $this->assertInstance($obj, 'Foresmo_Model_Permissions');
    }
