 ...
 * 
 */
class Test_Foresmo_Model_Modules_Collection extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Foresmo_Model_Modules_Collection = array(
    );
    ...
    {
        $obj = Solar::factory('Foresmo_Model_Modules_Collection');
        $this->assertInstance($obj, 'Foresmo_Model_Modules_Collection');
    }
