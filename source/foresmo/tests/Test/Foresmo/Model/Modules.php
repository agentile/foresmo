 ...
 * 
 */
class Test_Foresmo_Model_Modules extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Foresmo_Model_Modules = array(
    );
    ...
    {
        $obj = Solar::factory('Foresmo_Model_Modules');
        $this->assertInstance($obj, 'Foresmo_Model_Modules');
    }
