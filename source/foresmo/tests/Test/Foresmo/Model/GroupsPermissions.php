 ...
 * 
 */
class Test_Foresmo_Model_GroupsPermissions extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Foresmo_Model_GroupsPermissions = array(
    );
    ...
    {
        $obj = Solar::factory('Foresmo_Model_GroupsPermissions');
        $this->assertInstance($obj, 'Foresmo_Model_GroupsPermissions');
    }
    ...
    /**
     * 
     * Test -- getGroupPermissionsByID
     * 
     */
    public function testGetGroupPermissionsByID()
    {
        $this->todo('stub');
    }
