 ...
 * 
 */
class Test_Foresmo_Model_Options_Record extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Foresmo_Model_Options_Record = array(
    );
    ...
    {
        $obj = Solar::factory('Foresmo_Model_Options_Record');
        $this->assertInstance($obj, 'Foresmo_Model_Options_Record');
    }
