 ...
 * 
 */
class Test_Foresmo_Model_CommentInfo extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Foresmo_Model_CommentInfo = array(
    );
    ...
    {
        $obj = Solar::factory('Foresmo_Model_CommentInfo');
        $this->assertInstance($obj, 'Foresmo_Model_CommentInfo');
    }
