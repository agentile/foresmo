 ...
 * 
 */
class Test_Foresmo_Model_UserInfo extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Foresmo_Model_UserInfo = array(
    );
    ...
    {
        $obj = Solar::factory('Foresmo_Model_UserInfo');
        $this->assertInstance($obj, 'Foresmo_Model_UserInfo');
    }
    ...
    /**
     * 
     * Test -- getUserInfoByID Get extended user information by user ID.
     * 
     */
