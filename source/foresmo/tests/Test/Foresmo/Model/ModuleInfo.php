 ...
 * 
 */
class Test_Foresmo_Model_ModuleInfo extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Foresmo_Model_ModuleInfo = array(
    );
    ...
    {
        $obj = Solar::factory('Foresmo_Model_ModuleInfo');
        $this->assertInstance($obj, 'Foresmo_Model_ModuleInfo');
    }
