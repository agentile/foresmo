 ...
 * 
 */
class Test_Foresmo_Model_Links extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Foresmo_Model_Links = array(
    );
    ...
    {
        $obj = Solar::factory('Foresmo_Model_Links');
        $this->assertInstance($obj, 'Foresmo_Model_Links');
    }
