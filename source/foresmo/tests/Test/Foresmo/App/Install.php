 ...
 * 
 */
class Test_Foresmo_App_Install extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Foresmo_App_Install = array(
    );
    ...
    {
        $obj = Solar::factory('Foresmo_App_Install');
        $this->assertInstance($obj, 'Foresmo_App_Install');
    }
