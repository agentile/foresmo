 ...
 * 
 */
class Test_Foresmo_App_Base extends Solar_Test {
     ...
     * 
     */
    protected $_Test_Foresmo_App_Base = array(
    );
    ...
    {
        $obj = Solar::factory('Foresmo_App_Base');
        $this->assertInstance($obj, 'Foresmo_App_Base');
    }
