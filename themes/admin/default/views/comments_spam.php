        <div class="grid_16">
            <h2 class="page-heading">Comments &#187; Spam</h2>
            <h2 class="page-heading-right"><?php echo $this->blog_title;?> administration</h2>
        </div>
        <div class="grid_16">
            <form action="/admin/comments/spam" method="post" id="comments_spam">
            <table id="manage_comments" summary="Comments">
                <caption>Spam Comments</caption>
                <thead>
                    <tr>
            ...
            <input type="hidden" name="ajax_action" value="admin_comments_spam" />
            <input type="submit" id="comments_spam_submit" name="submit" value="Submit" class="submit_input"/>
            </form><br/>
        </div>
        <div class="clear"></div>